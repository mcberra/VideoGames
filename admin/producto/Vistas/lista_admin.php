...
<form class="form-inline" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <button type="submit"class="w3-btn w3-grey" >  Buscar</button>
            ...
            <a href="utilidades/descargar.php?opcion=TXT" class="w3-btn w3-black" target="_blank">  TXT</a>
            <a href="utilidades/descargar.php?opcion=JSON" class="w3-btn w3-black" target="_blank">  JSON</a>
            <a href="javascript:window.print()" class="w3-btn w3-black"> IMPRIMIR</a>
            <a href="/Alum1/Vistas/create.php" class="w3-btn w3-green">  Añadir Item</a>
</form>
 <style>
#pag{
...
<?php
    ...
    $controlador = ControladorAlumno::getControlador();
       ...
       $consulta = "SELECT * FROM usuario WHERE nombre LIKE :nombre AND apellido LIKE :apellido";
