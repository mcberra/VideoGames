    ...
    public function procesarIdentificacion($email, $password){
           ...
           //admin=:admin and ':admin'=>'si',
            ...
            if (count($filas) > 0) { //con count($filas) > 0 me da error al usar otra tabla.
                 ...
                 header("location: /games/admin/administracion.php"); 
                 exit();              
            } else {
                        ...
                        echo "<div class='row'>";
                            echo "<div class='col-md-12'>";
                                ...
                                echo "<div class='alert alert-warning fade in'>";
                                    echo "<p>Lo siento, el emial o password es incorrecto. Por favor <a href='/games/admin/producto/Vistas/login.php' class='alert-link'>regresa</a> e inténtelo de nuevo.</p>";
                                    echo$_SESSION['USUARIO']['email'];
                                    //echo $email;
                                    //echo $password;
